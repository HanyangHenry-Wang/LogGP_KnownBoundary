...
for information in function_information:
    ...
    np.savetxt('exp_res_2/'+information['name']+'_GP+EI', BO_EI, delimiter=',')
    ...
    np.savetxt('exp_res_2/'+information['name']+'_GP+MES', BO_MES, delimiter=',')
...
################################## logGP+EI (no boundary) ######################################
    ...
    np.savetxt('exp_res_2/'+information['name']+'_logGP(NoBoundary)+logEI', logBO_no_boundary_logEI, delimiter=',')
    ...
    np.savetxt('exp_res_2/'+information['name']+'_logGP+logEI', Warped_BO_logEI, delimiter=',')
    ...
    np.savetxt('exp_res_2/'+information['name']+'_logGP+logTEI'+'_0.2', Warped_BO_logTEI, delimiter=',')
    ...
    np.savetxt('exp_res_2/'+information['name']+'_transformedGP+ERM', BO_ERM, delimiter=',')
...
############################ GP TEI #################################################
    ...
    np.savetxt('exp_res_2/'+information['name']+'_GP+TEI', BO_TEI, delimiter=',')
